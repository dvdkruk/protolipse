		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProtoAccess().getGroup_0(), "rule__Proto__Group_0__0");
					...
					put(grammarAccess.getProtoAccess().getSyntaxAssignment_0_2(), "rule__Proto__SyntaxAssignment_0_2");
