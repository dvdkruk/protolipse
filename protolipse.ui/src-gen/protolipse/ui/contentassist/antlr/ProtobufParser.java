		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExtensionRangeAccess().getFromAssignment_1(), "rule__ExtensionRange__FromAssignment_1");
					put(grammarAccess.getExtensionRangeAccess().getToAssignment_2_1(), "rule__ExtensionRange__ToAssignment_2_1");
